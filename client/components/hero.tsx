      ...
      <div className="max-w-7xl pb-24 pt-10 sm:pb-32 lg:flex ml-4 px-4 lg:ml-48  lg:py-24">
        <div className=" max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            {isLoggedIn ? (
              <a href='/top-tracks' className='bg-indigo-600 text-sm px-6 py-2.5 rounded-lg text-white'>Votre journal</a>
            ) : (
                <a href='/signup' className='bg-indigo-600 text:sm px-6 py-2.5 rounded-lg text-white'>Commencer</a>
            )}
